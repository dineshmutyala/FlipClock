...
public class FlipClockView : ScreenSaverView{
    ...
    var seperatorWidth : CGFloat{
        get{
            return frameToDraw.width * 0.05
        }
    }
    
    var secondsWidth : CGFloat{
        get{
            return frameToDraw.width * 0.15
        }
    }
    ...
    public override func animateOneFrame() {
        ...
        updateIfNeeded(prev: &prevSeconds1s, curr: seconds1s, view: sec1sView, frame: sec1sFrame)

        setNeedsDisplay(bounds)
    }
    
    private func updateIfNeeded( prev: inout Int, curr: Int, view: NumberView, frame: CGRect, inset: CGFloat = 0){
